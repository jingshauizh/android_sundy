...
public class ActivityMenu extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lv.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
                ...
                Toast.makeText(ActivityMenu.this, "弹出上下文菜单", Toast.LENGTH_SHORT);
                return false;
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.getItem(0).setIcon(R.drawable.image);
        menu.getItem(1).setIcon(R.drawable.image);
        menu.getItem(2).setIcon(R.drawable.image);
    ...
    private void buildRadioDialog() {
        ...
        builder.setSingleChoiceItems(titles, -1,
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        // TODO Auto-generated method stub
                        Toast.makeText(ActivityMenu.this, titles[which],
                                Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                // TODO Auto-generated method stub
                Toast.makeText(ActivityMenu.this, "确定", Toast.LENGTH_SHORT)
                        .show();
            }
        });
        ...
        builder.setNegativeButton("取消", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                // TODO Auto-generated method stub
                Toast.makeText(ActivityMenu.this, "取消", Toast.LENGTH_SHORT)
                        .show();
            }
        });
        ...
        builder.setMultiChoiceItems(titles,
                ...
                new DialogInterface.OnMultiChoiceClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which,
                        ...
                        //当checkbox选中时响应
                        if (isChecked) {
                            Toast.makeText(ActivityMenu.this,
