 ...
 * and
 */
public class PlayerTest implements SensorEventListener {
    ...
    /**
     * Creates a new instance of <code>PlayerTest</code>.
     * 
     * @param videoWidth the video width that want to play.
     * @param videoHeight the video height that want to play.
     */
    public PlayerTest(int videoWidth, int videoHeight, AssetManager assetManager, Context context) {
