...
public class PlayerActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private PlayerTest playerTest = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playerTest = new PlayerTest(videoWidth, videoHeight, getAssets(), this);
        ...
        startBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                playerTest.setLocalIpAndPort(localip, (short) Integer.parseInt(localport));
                playerTest.setRemoteIpAndPort(remoteip, (short) Integer.parseInt(remoteport));

                try {
                    if (isFirstTime) {
                        playerTest.setSurfaceView(renderView);
                        playerTest.init();
                        playerTest.open();
                        isFirstTime = false;
                    }
