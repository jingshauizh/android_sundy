package com.chenww.camera.ui.backup;
/**
 * 用来拍照的Activity
 * @author Chenww
 */
...
public class CameraActivityBack extends Activity {
	...
	private PictureCallback myPicCallback = new PictureCallback() {
		...
		public void onPictureTaken(byte[] data, Camera camera) {
			//完成拍照后关闭Activity
			CameraActivityBack.this.finish();
			...
			try {
				...
				Toast.makeText(CameraActivityBack.this, "fail", Toast.LENGTH_SHORT).show();
			...
			Log.d("Demo", "获取照片成功");
			Toast.makeText(CameraActivityBack.this, "done", Toast.LENGTH_SHORT).show();
			myCamera.stopPreview();
			myCamera.release();
			myCamera = null;
		}
