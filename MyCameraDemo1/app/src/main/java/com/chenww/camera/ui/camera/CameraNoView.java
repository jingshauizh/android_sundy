package com.chenww.camera.ui.camera;
...
/**
 * Created by eqruvvz on 6/24/2016.
 */
public class CameraNoView {

    private final String TAG="CameraNoView";
    ...
    private Boolean saveedFlas =false;

    private Context mContext;

    public CameraNoView(Context pContext){
        this.mContext = pContext;
        this.mSurfaceTexture = new SurfaceTexture(344);
        this.mSurface = new Surface(mSurfaceTexture);
    }

    public CameraNoView(Context pContext, Surface pSurface){
        this.mContext = pContext;
        this.mSurface = pSurface;
    }
    ...
    class JpegPreviewCallback  implements Camera.PreviewCallback {
        ...
        public void onPreviewFrame(byte[] data, Camera camera) {
            ...
            Log.v(TAG,"onPreviewFrame data="+data.length);
            ...
            if(currentTime - checkTime > 200 && yuvdata != null){
                ...
                Thread save = new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        saveedFlas = Storage.savePicture(yuvdata, fileName,
