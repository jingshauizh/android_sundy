...
Lisp_AVFrame * createFrame(int size_y, unsigned char * data_y, int size_u,
...
void freeAVFrame(Lisp_AVFrame ** ppFrame)
{
    if (NULL == ppFrame || NULL == *ppFrame)
    {
        return;
    }
    Lisp_AVFrame * pFrame = *ppFrame;
