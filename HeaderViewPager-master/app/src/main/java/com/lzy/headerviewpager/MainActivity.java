...
import com.lzy.zjs.HeaderViewPagerN;
import com.lzy.zjs.HeaderViewPagerZjs;

public class MainActivity extends BaseActivity {

    public List<HeaderViewPagerFragment> fragments;
    private HeaderViewPagerZjs scrollableLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scrollableLayout = (HeaderViewPagerZjs) findViewById(R.id.scrollableLayout);
...
//            }
//        });
//        scrollableLayout.setOnScrollListener(new HeaderViewPagerN.OnScrollListener() {
//            @Override
