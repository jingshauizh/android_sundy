...
public class HeaderViewPagerN extends LinearLayout {
   ...
   private OnScrollListener onScrollListener;   //滚动的监听
    ...
    public HeaderViewPagerN(Context context) {
        this(context, null);
    }

    public HeaderViewPagerN(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HeaderViewPagerN(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onFinishInflate() {
        ...
        //在所有view load success 后 set head view clickable
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //mHeadHeight = 50;
        //mHeadHeight head view height
        //topOffset title bar height
        //maxY max scroll out distance
        ...
        //让测量高度加上头部的高度  为什么 觉得没有必要呀？ 【question】
            ...
            if (mDirection == DIRECTION_UP) {
                ...
                if (isStickied()) {
                    ...
                    if (mscrollableView instanceof ScrollView){
                        ((ScrollView) mscrollableView).fling(getScrollerVelocity(distance, duration));
                    }
