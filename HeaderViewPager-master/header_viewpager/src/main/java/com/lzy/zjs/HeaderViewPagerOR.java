...
public class HeaderViewPagerOR extends LinearLayout {
    ...
    private HeaderScrollHelperN mScrollable;
    ...
    public HeaderViewPagerOR(Context context) {
        this(context, null);
    }

    public HeaderViewPagerOR(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HeaderViewPagerOR(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mScrollable = new HeaderScrollHelperN();
