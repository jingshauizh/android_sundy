...
import com.mvp.jingshuai.android_iod.Injection;
import com.mvp.jingshuai.android_iod.R;

import com.mvp.jingshuai.android_iod.util.ActivityUtils;
...
public class InfoODetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new InfoODetailPresenter(
                taskId,
                Injection.provideBusinessRepository(getApplicationContext()),
